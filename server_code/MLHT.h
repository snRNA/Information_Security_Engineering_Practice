...
#define MLHT_MTU_TYPE_SHELL_LS 1				//SHELL_LS
#define MLHT_MTU_TYPE_SHELL_DIR 1				//SHELL_DIR
#define MLHT_MTU_TYPE_SHELL_CD 2				//SHELL_CD
#define MLHT_MTU_TYPE_SHELL_MKDIR 3				//SHELL_MKDIR
#define MLHT_MTU_TYPE_SHELL_RMDIR 4				//SHELL_RMDIR
#define MLHT_MTU_TYPE_SHELL_RM 5				//SHELL_RM
#define MLHT_MTU_TYPE_SHELL_UPLOAD 6			//SHELL_UPLOAD
#define MLHT_MTU_TYPE_SHELL_DOWNLOAD 7			//SHELL_DOWNLOAD
...
private://协议内容
    ...
    WORD slice_num;				//第几个分片 1byte
    WORD slice_sum;				//共几个分片 1byte
